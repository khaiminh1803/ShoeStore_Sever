...
const updateTotalPrice = async (userId, totalPrice, selectedItems) => {
    try {
        ...
        cart.items.forEach(item => {
            item.isChecked = selectedItems[item.product._id.toString()] || false;
        });
        ...
        console.error('Update total price error:', error);
        throw error;
    }
};


module.exports = { addItem, getAllItems, removeItem, increaseItemQuantity, decreaseItemQuantity, updateTotalPrice }
